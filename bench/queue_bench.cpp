// Throughput benchmarks for cq::MutexQueue (v1) against two industrial
// queues (roadmap v3): moodycamel::ConcurrentQueue and
// tbb::concurrent_bounded_queue. One templated harness runs every queue so
